...
import 'package:yebhofon/model/BaseModel.dart';

AssuranceModel assuranceModelFromJson(String str) =>
    AssuranceModel.fromJson(json.decode(str));

String assuranceModelToJson(AssuranceModel data) => json.encode(data.toJson());
...
class AssuranceModel extends BaseModel {
  ...
  factory AssuranceModel.fromJson(Map<String, dynamic> json) => AssuranceModel(
        status: json["status"],
